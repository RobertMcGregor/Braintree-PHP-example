...
<div class="container">
	...
	<form id="restForm" method="get">
		<table>
			...
			<tr>
				<td> Option 2 </td>
				<td> <input id="option_2" type="text" name="command_2"><br> </td>
			</tr>

			<tr>
				<td> Option 3 </td>
				<td> <input id="option_3" type="text" name="command_3"><br> </td>
			</tr>

			<tr>
				<td> Option 4 </td>
				<td> <input id="option_4" type="text" name="command_4"><br> </td>
			</tr>
			<tr>			
				<td></td>
